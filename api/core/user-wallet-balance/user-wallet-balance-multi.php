...
class User_Wallet_Balance_Multi extends RimplenetGetWalletBalanceMulti
{
    ...
    {
        register_rest_route('/rimplenet/v1', 'user-wallet-balance/multi', [
            'methods' => 'GET',
    ...
    {
        do_action( 'nll_api_request', $req, $allowed_roles = ['admin'], $action = 'get_rimplenet_wallets_balance');
...
$User_Wallet_Balance_Multi  = new User_Wallet_Balance_Multi ();