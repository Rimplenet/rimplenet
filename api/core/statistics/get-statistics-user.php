...
$rimplenet_wallet_addon_get_statistic_user = new class extends RimplenetStatistics
{
    ...
    {
        register_rest_route('/rimplenet/v1', 'statistics/(?P<meta_key>\S+)/(?P<wallet_id>[a-zA-Z0-9-]+)/user/(?P<slug>[a-zA-Z0-9-]+)', [
            'methods' => 'GET',
